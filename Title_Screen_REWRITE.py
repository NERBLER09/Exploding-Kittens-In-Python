...
def play_button_clicked():
    play = tk.messagebox.askquestion("Exploding Kittens Main Menu", "The game is very incomplete, are you sure you want to continue?")
