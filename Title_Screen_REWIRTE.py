...
windows = Tk()
windows.title("Exploding Kittens Main Menu") # Renames the windows to: Exploding Kittens Main Menu
...
# Functions needed 
def button_clicked():
    contuine = messagebox.askquestion("Exploding Kittens Main Menu", "The game is very incompleate, are you sure you want to contuine?")
...
play_button = Button(windows, text="PLAY", bg = "#DF0101", font = "40", command=button_clicked)
